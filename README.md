...
## Current Happenings
* Right now, I'm wrapping up [The Odin Project](https://theodinproject.com), and working through the Ruby on Rails course.
...
* [Railsbook](https://railsbook.crespire.dev) - A Facebook clone built with Rails 7 that leverages hotwired to achieve a smooth UX experience.
* [Ruby Chess](https://replit.com/@crespire/rubychess?lite=1&outputonly=1#README.md) - A from-scratch command line Chess program for 2 players.
